 ...
 * wallets. Provided via env; a placeholder is used in local/dev builds so the
 * app can boot without external configuration.
 */
const walletConnectProjectId =
  process.env['NEXT_PUBLIC_WALLETCONNECT_PROJECT_ID'] ?? 'bfn-local-development';
